 ...
 * <p>
 * With {@link ninja.leaping.configurate.reactive.Publisher}, {@link
 * ninja.leaping.configurate.reactive.Subscriber}, and
 * {@link ninja.leaping.configurate.reactive.Processor},
 ...
 * {@link ninja.leaping.configurate.reactive.Processor#create()
 * creating a processor}, and making it available for users to {@link
 * ninja.leaping.configurate.reactive.Subscriber subscribe} to. Then, any value {@link
 * ninja.leaping.configurate.reactive.Subscriber#submit(java.lang.Object) submitted} to the
 * Processor will be forwarded to every registered subscriber.
 * <p>
 * In many cases, it is best to only expose the
 * {@link ninja.leaping.configurate.reactive.Publisher}
